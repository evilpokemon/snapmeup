...
class Authenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response,
        ...
        intent.putExtra(AuthenticatorActivity.PARAM_AUTHTOKEN_TYPE,
            authTokenType);
        Log.v("Authenticator", "Authtokentype is " + authTokenType);
    ...
    public Bundle editProperties(AccountAuthenticatorResponse response,
        String accountType) {
        //TODO add editProperties handler
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response,
        ...
        if (password != null) {
            ...
            if (verified) {
                ...
                Log.v("Authenticator", "all is good");
                return result;
            }
        }
        // the password was missing or incorrect, return an Intent to an
        // Activity that will prompt the user for the password.
        Log.v("Authenticator", "launching intent");
        final Intent intent = new Intent(mContext, AuthenticatorActivity.class);
        intent.putExtra(AuthenticatorActivity.PARAM_USERNAME, account.name);
        intent.putExtra(AuthenticatorActivity.PARAM_AUTHTOKEN_TYPE,
            authTokenType);
    ...
    boolean bResult;
    	bResult = TextUtils.equals(
    			Interactor.validateCredentials(username, password, mContext.getResources()), 
    			mContext.getString(R.string.server_validation_valid)) ;
    	return bResult;
    }
